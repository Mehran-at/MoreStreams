    ...
    public static void main(String[] args) {
        ...
        Optional<String> mostAppeared =wordAppearances.entrySet().stream()
                ...
                if(mostAppeared.isPresent()) {
                    System.out.println("Most appearing words: " + mostAppeared);
                }
        ...
        mostAppearingThreeLetters.forEach(e -> System.out.println());
        ...
        System.out.println("Any maatch: " + isThereOneWordWithLength);
